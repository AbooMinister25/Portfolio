    ...
    return (
        <div className="h-screen flex flex-col">
            ...
            <div className="flex flex-row justify-center md:justify-start my-5 md:ml-72">
                <Link href="https://github.com/AbooMinister25">
                    <a target="blank">
                        <svg
                            ...
                            height="30"
                            viewBox="0 0 24 24"
                            className="fill-current text-onemagenta mx-3"
                        >
                ...
                <Link href="https://www.linkedin.com/in/rayyan-cyclegar-445b63216/">
                    <a target="blank">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="30"
                            height="30"
                            viewBox="0 0 24 24"
                            className="fill-current text-onered mx-3"
                        >
                ...
                <Link href="https://www.instagram.com/aboominister/">
                    <a target="blank">
                        <svg
                            ...
                            height="30"
                            viewBox="0 0 24 24"
                            className="fill-current text-oneyellow mx-3"
                        >
